...
/**
 * struct wm8904_drc_cfg - DRC configurations are specified with a label
 * and a set of register values to write (the enable bits will be ignored).
 * At runtime an enumerated control will be presented for each DRC block
 * allowing the user to choose the configuration to use.
 *
...
/**
 * struct wm8904_retune_mobile_cfg - ReTune Mobile configurations are
 * specified with a label, sample rate and set of values to write
 * (the enable bits will be ignored).
 *
