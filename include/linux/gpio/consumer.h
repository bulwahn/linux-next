...
/**
 * struct gpio_desc - Opaque descriptor for a GPIO. These are obtained using
 * gpiod_get() and are preferable to the old integer-based handles.
 *
 ...
 * attributes.  This structure is attached to struct gpiod_descs obtained from
 ...
 * configure direction and output value. These values cannot be OR'd.
 */
enum gpiod_flags {
	GPIOD_ASIS	= 0,
